            ...
            success: (data) => {
                $.each(data, function (key, item) {
                    ...
                    var $tr = $('<tr data-id="' + item.Id + '">').append(
                        ...
                        $('<td>').html('<a  class="text-muted pointer margin-left-5px text-center"   onClick="Details('+ item.Id +')"    data-toggle="tooltip" data-html="true" title="Visualizar"><span data-feather="eye">Visualizar</span></a>'),
...
function Details(Id) {
    window.location.href = 'details/finalizadas/' + Id;
}